...
int main(int argc, char *argv[]){
    int status; //This will hold the overall status of the system command.
...
int cs531_system(const char* s){
   ...
   */
   ...
   if (child = fork() == 0){
        //This is the child process operating
        ...
        if (child == (pid_t)(-1)){
            ...
            do {
                ...
                if (WIFEXITED(cstatus)){ 
                    ...
                    //If the child process was terminated abruptly by some signal - i.e. SIGQUIT
